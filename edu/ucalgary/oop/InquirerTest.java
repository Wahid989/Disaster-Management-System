...
public void setUp() {
    ...
    inquirer.addInteraction(expectedMessage); 
}
...
*/
@Test
public void testGetFirstInteraction() {
    assertEquals("Should return the first interaction message", expectedMessage, inquirer.getInteractions().get(0));
}
