...
@Test
    ...
    public void testGetDateOfTreatment() {
        // Convert LocalDate to String for comparison
        String actualDateOfTreatmentStr = medicalRecord.getDateOfTreatment().toString();
        assertEquals("getDateOfTreatment should return the correct date of treatment", expectedDateOfTreatment, actualDateOfTreatmentStr);
    }
    ...
    public void testSetDateOfTreatment() {
        ...
        // Convert LocalDate to String for comparison
        String actualDateOfTreatmentStr = medicalRecord.getDateOfTreatment().toString();
        assertEquals("setDateOfTreatment should update date of treatment", newExpectedDateOfTreatment, actualDateOfTreatmentStr);
    }
